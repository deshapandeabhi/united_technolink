  ...
  return (
    <section className="relative pt-28 pb-14 sm:pt-36 sm:pb-20 lg:pt-44 lg:pb-24 overflow-hidden bg-ink-950 isolate">
      ...
      <Container className="relative z-10">
        ...
        <h1 className="mt-5 sm:mt-6 text-center font-display font-semibold text-brand-300 text-3xl sm:text-5xl lg:text-6xl leading-[1.12] sm:leading-[1.08] tracking-tight max-w-4xl mx-auto">
          {title}
        </h1>
        {body && (
