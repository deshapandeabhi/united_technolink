          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-12 lg:gap-14 items-center">
            ...
            >
              {["Private Cloud", "Hybrid Cloud", "Multi-Cloud", "Turnkey Deployments"].map((c) => (
                <div key={c} className="rounded-2xl bg-white/10 border border-white/20 p-4 sm:p-6 aspect-square flex flex-col justify-between hover:bg-white/15 transition-colors">
